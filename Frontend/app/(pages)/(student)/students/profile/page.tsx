...
export default function StudentProfilePage() {
  ...
  return (
    <div className="min-h-full w-full bg-[#F3F4F6] px-[13px] py-[17px] rounded-lg">
      ...
      <div className="grid w-full grid-cols-1 md:grid-cols-[256px_minmax(0,1fr)] gap-[12px]">
        {/* LEFT MENU */}
        <aside className="w-full md:w-[256px]">
