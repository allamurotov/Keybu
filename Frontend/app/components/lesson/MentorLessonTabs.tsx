...
interface MentorLessonTabsProps {
  courseId: string;
  sectionId: string;
  lessonId: string;
...
export default function MentorLessonTabs({ courseId, sectionId, lessonId, active }: MentorLessonTabsProps) {
  const base = `/mentor/courses/${courseId}/sections/${sectionId}/lessons/${lessonId}`;
